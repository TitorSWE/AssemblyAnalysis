	...
	.text
	.globl	__merger_cond_true_445705340
	.data
	.align 4
	.type	__merger_cond_true_445705340, @object
	.size	__merger_cond_true_445705340, 4
__merger_cond_true_445705340:
	.long	1
	.text
...
mov rax, rdx
	mov	eax, DWORD PTR __merger_cond_true_445705340[rip]
	test	eax, eax
	jne	.L396
...
mov rdx, rcx
sub rax, rdx
	cvtsi2sd	xmm3, QWORD PTR -80[rbp]
	movq	rdx, xmm3
	mov	rax, QWORD PTR -72[rbp]
mov rax, rcx
	movq	xmm0, rdx
