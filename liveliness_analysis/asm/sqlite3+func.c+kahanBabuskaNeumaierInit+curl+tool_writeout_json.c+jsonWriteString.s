	...
	.text
	.globl	__merger_cond_true_482318269
	.data
	.align 4
	.type	__merger_cond_true_482318269, @object
	.size	__merger_cond_true_482318269, 4
__merger_cond_true_482318269:
	.long	1
	.text
...
.L404:
	...
	mov	eax, DWORD PTR __merger_cond_true_482318269[rip]
	test	eax, eax
	je	.L405
	pxor	xmm0, xmm0
	cvtsi2sd	xmm0, QWORD PTR -224[rbp]
	mov	rax, QWORD PTR -216[rbp]
	movsd	QWORD PTR [rax], xmm0
	mov	rax, QWORD PTR -216[rbp]
	pxor	xmm0, xmm0
