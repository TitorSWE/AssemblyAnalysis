	...
	.text
	.globl	__merger_cond_true_1049458167
	.data
	.align 4
	.type	__merger_cond_true_1049458167, @object
	.size	__merger_cond_true_1049458167, 4
__merger_cond_true_1049458167:
	.long	1
	.text
...
.L404:
	...
	mov	eax, DWORD PTR __merger_cond_true_1049458167[rip]
	test	eax, eax
	je	.L400
	mov	DWORD PTR -4[rbp], 0
	...
	pxor	xmm2, xmm2
	cvtsi2sd	xmm2, QWORD PTR -56[rbp]
	movq	rdx, xmm2
	mov	rax, QWORD PTR -88[rbp]
	movq	xmm0, rdx
	mov	rdi, rax
...
.L403:
	...
	jne	.L405
	pxor	xmm3, xmm3
	cvtsi2sd	xmm3, QWORD PTR -96[rbp]
	movq	rdx, xmm3
	mov	rax, QWORD PTR -88[rbp]
	movq	xmm0, rdx
	mov	rdi, rax
