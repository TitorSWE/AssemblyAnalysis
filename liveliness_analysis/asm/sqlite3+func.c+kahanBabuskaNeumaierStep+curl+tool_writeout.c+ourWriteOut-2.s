	...
	.text
	.globl	__merger_cond_true_81780006
	.data
	.align 4
	.type	__merger_cond_true_81780006, @object
	.size	__merger_cond_true_81780006, 4
__merger_cond_true_81780006:
	.long	1
	.text
...
shl rax, 3
	...
	mov	eax, DWORD PTR __merger_cond_true_81780006[rip]
mov rdi, rax
	test	eax, eax
	jne	.L390
cmp eax,0x100
...
call 0x100
	...
	movsd	xmm1, QWORD PTR -440[rbp]
	movsd	xmm0, QWORD PTR -464[rbp]
	addsd	xmm0, xmm1
mov rdi, rax
call 0x100
