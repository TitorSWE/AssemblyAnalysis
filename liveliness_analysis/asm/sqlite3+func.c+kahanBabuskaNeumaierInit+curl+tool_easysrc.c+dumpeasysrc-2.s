	...
	.text
	.globl	__merger_cond_true_830654379
	.data
	.align 4
	.type	__merger_cond_true_830654379, @object
	.size	__merger_cond_true_830654379, 4
__merger_cond_true_830654379:
	.long	1
	.text
...
cdqe
	jne	.L404
	pxor	xmm0, xmm0
	cvtsi2sd	xmm0, QWORD PTR -208[rbp]
	mov	rax, QWORD PTR -200[rbp]
	movsd	QWORD PTR [rax], xmm0
...
mov rdi, rax
	mov	eax, DWORD PTR __merger_cond_true_830654379[rip]
call 0x100
mov rax, qword ptr [rbp - 8]
mov rsi, rdx
	test	eax, eax
