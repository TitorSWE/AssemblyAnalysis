	...
	.text
	.globl	__merger_cond_true_1072572352
	.data
	.align 4
	.type	__merger_cond_true_1072572352, @object
	.size	__merger_cond_true_1072572352, 4
__merger_cond_true_1072572352:
	.long	1
	.text
...
.LFB52:
	...
	mov	eax, DWORD PTR __merger_cond_true_1072572352[rip]
	test	eax, eax
	jne	.L400
...
.L444:
	...
	mov	DWORD PTR -4[rbp], 0
	pxor	xmm0, xmm0
	cvtsi2sd	xmm0, QWORD PTR -464[rbp]
	mov	rax, QWORD PTR -456[rbp]
	movsd	QWORD PTR [rax], xmm0
	mov	rax, QWORD PTR -456[rbp]
	pxor	xmm0, xmm0
