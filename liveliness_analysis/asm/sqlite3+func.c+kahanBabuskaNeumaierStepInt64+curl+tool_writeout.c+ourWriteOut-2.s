	...
	.text
	.globl	__merger_cond_true_1073075436
	.data
	.align 4
	.type	__merger_cond_true_1073075436, @object
	.size	__merger_cond_true_1073075436, 4
__merger_cond_true_1073075436:
	.long	1
	.text
...
add rax, rax
	mov	eax, DWORD PTR __merger_cond_true_1073075436[rip]
	test	eax, eax
mov rdi, rax
	jne	.L396
mov rsi, rax
...
cmp al,0x100
	pxor	xmm3, xmm3
	cvtsi2sd	xmm3, QWORD PTR -464[rbp]
	movq	rdx, xmm3
mov rsi, rax
