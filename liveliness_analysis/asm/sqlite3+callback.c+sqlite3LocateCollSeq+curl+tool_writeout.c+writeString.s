	...
	.text
	.globl	__merger_cond_true_382340597
	.data
	.align 4
	.type	__merger_cond_true_382340597, @object
	.size	__merger_cond_true_382340597, 4
__merger_cond_true_382340597:
	.long	1
	.text
...
.L33:
	...
	mov	eax, DWORD PTR __merger_cond_true_382340597[rip]
	test	eax, eax
	je	.L35
...
.L76:
	...
	mov	DWORD PTR -460[rbp], -2
	mov	eax, DWORD PTR __merger_cond_true_382340597[rip]
	test	eax, eax
	jne	.L77
	mov	DWORD PTR -464[rbp], 3
.L77:
	mov	DWORD PTR -468[rbp], 3
.L75:
	mov	DWORD PTR -472[rbp], -2
	mov	eax, DWORD PTR __merger_cond_true_382340597[rip]
	test	eax, eax
	jne	.L78
	mov	DWORD PTR -476[rbp], 3
	mov	DWORD PTR -480[rbp], -2
	mov	eax, DWORD PTR __merger_cond_true_382340597[rip]
	test	eax, eax
	jne	.L79
	mov	DWORD PTR -484[rbp], 3
.L79:
	mov	DWORD PTR -488[rbp], 3
.L78:
	mov	rax, QWORD PTR -8[rbp]
	leave
	.cfi_def_cfa 7, 8
