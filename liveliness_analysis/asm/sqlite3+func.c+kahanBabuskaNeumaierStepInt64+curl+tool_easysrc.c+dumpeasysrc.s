	...
	.text
	.globl	__merger_cond_true_214559595
	.data
	.align 4
	.type	__merger_cond_true_214559595, @object
	.size	__merger_cond_true_214559595, 4
__merger_cond_true_214559595:
	.long	1
	.text
...
.L399:
	...
	jne	.L400
	pxor	xmm3, xmm3
	cvtsi2sd	xmm3, QWORD PTR -224[rbp]
	movq	rdx, xmm3
	mov	rax, QWORD PTR -216[rbp]
	movq	xmm0, rdx
	mov	rdi, rax
...
.L400:
	...
	mov	eax, DWORD PTR __merger_cond_true_214559595[rip]
	test	eax, eax
	jne	.L401
