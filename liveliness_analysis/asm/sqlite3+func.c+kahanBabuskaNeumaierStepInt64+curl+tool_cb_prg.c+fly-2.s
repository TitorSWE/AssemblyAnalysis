	...
	.text
	.globl	__merger_cond_true_986720592
	.data
	.align 4
	.type	__merger_cond_true_986720592, @object
	.size	__merger_cond_true_986720592, 4
__merger_cond_true_986720592:
	.long	1
	.text
...
mov rax, qword ptr [rbp - 0x118]
mov rax, qword ptr [rbp - 0x118]
mov byte ptr [rbp + rax - 0x110],0x100
	mov	eax, 0
mov rax, qword ptr [rbp - 0x118]
mov ecx, dword ptr [rdx + rax]
.L398:
...
mov rax, qword ptr [rbp - 0x118]
	...
	pxor	xmm2, xmm2
	cvtsi2sd	xmm2, QWORD PTR -16[rbp]
mov eax, ecx
mov eax, dword ptr [rax + 0x38]
	movq	rdx, xmm2
	mov	rax, QWORD PTR -56[rbp]
...
mov eax, eax
	pxor	xmm3, xmm3
lea rdx, [rax*4]
	cvtsi2sd	xmm3, QWORD PTR -64[rbp]
mov rax, qword ptr [rbp - 0x118]
mov rax, qword ptr [rbp - 0x118]
	movq	rdx, xmm3
mov eax, ecx
...
mov eax, dword ptr [rax + 0x38]
	mov	eax, DWORD PTR __merger_cond_true_986720592[rip]
