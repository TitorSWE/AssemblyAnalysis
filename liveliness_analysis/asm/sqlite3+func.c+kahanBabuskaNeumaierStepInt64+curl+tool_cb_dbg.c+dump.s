	...
	.text
	.globl	__merger_cond_true_766454407
	.data
	.align 4
	.type	__merger_cond_true_766454407, @object
	.size	__merger_cond_true_766454407, 4
__merger_cond_true_766454407:
	.long	1
	.text
...
.L412:
	...
	mov	eax, DWORD PTR __merger_cond_true_766454407[rip]
	test	eax, eax
	je	.L401
	mov	DWORD PTR -8[rbp], 0
	jmp	.L402
.L405:
	...
	mov	DWORD PTR -4[rbp], 0
	pxor	xmm3, xmm3
	cvtsi2sd	xmm3, QWORD PTR -128[rbp]
	movq	rdx, xmm3
	mov	rax, QWORD PTR -120[rbp]
	movq	xmm0, rdx
	mov	rdi, rax
